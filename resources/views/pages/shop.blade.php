            ...
            <div class="grid md:grid-cols-3 grid-cols-2 gap-6">
                    @if ($products)
                        ...
                        <div class="bg-white shadow rounded overflow-hidden group">
                            <div class="relative">
                                <img src="{{asset($product->product_img)}}" alt="product 1" class="w-full">
                                <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center 
                               j justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
                            ...
                            <div class="pt-4 pb-3 px-4">
                                ...
                                <div class="flex items-baseline mb-1 space-x-2">
                                    ...
                                    <p class="text-sm text-gray-400 line-through">${{$product->product_old_price}}</p>
                                </div>
                                <div class="flex items-center">
                                    ...
                                    <div class="text-xs text-gray-500 ml-3">({{$product->product_quantity}})</div>
                                </div>
                            </div>
                                <form action="{{route('cart.add')}}" method="post">
                                    @csrf
                                    <input type="hidden" name="product_id" value="{{$product->id}}">
                                     <input type="number" name="quantity" id="quantity" placeholder="Enter quantity" min='1' value="1" max='100' class="focus:outline-none rounded-sm p-2 border border-gray-200 w-full">
                                    <button class="block w-full py-1 text-center text-white bg-primary border border-primary rounded-b hover:bg-transparent hover:text-primary transition">Add to cart</button>
                                </form>
                        </div>
                        @endforeach
                    @else
